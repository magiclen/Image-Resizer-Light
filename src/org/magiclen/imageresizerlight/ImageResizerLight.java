...
public class ImageResizerLight extends Application {
    ...
    private TextField tfSource, tfDestination, tfMaxSide;
    private Slider sQuality;
    private Button bStartOrStop;
    private CheckBox cbOnlyShrink;
    ...
    private void run() {
        ...
        try {
            if (sourcePath.length() == 0) {
                showAlertDialog(AlertType.INFORMATION, "Hint", null, "You need input the path of source folder.");
                throw new Exception();
            }
            if (destinationPath.length() == 0) {
                showAlertDialog(AlertType.INFORMATION, "Hint", null, "You need input the path of destination folder.");
                throw new Exception();
            }
            ...
            if (!source.exists() || !source.isDirectory()) {
                showAlertDialog(AlertType.INFORMATION, "Hint", null, "You need to input the path of source folder correctly.");
                throw new Exception();
            }
            ...
            if (!destination.exists()) {
                ...
                showAlertDialog(AlertType.INFORMATION, "Hint", null, "You need to input the path of destination folder correctly.");
                throw new Exception();
            ...
            final boolean onShrink = cbOnlyShrink.isSelected();
                        ...
                        public void run() {
                            ...
                            for (final File file : imageFileList) {
                                ...
                                try {
                                    ...
                                    final BufferedImage result = ImageResize.resize(bi, maxSideSize, -1, onShrink, true);
    ...
    public void start(final Stage primaryStage) {
        ...
        tfSource.setPromptText("Click here 3 times or press enter to choose folder.");
        tfDestination.setPromptText("Click here 3 times or press enter to choose folder.");
        ...
        MAIN_ROOT.getChildren().addAll(lSource, tfSource, lDestination, tfDestination, lMaxSide, tfMaxSide, cbOnlyShrink, lQuality, sQuality, pbProgress, bStartOrStop, lAuthor);
